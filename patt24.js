const fs = require('fs');
const data = JSON.parse(fs.readFileSync('price24.json'));
...
if (isBullishHammer) {
  console.log('Внимание! Бычий молот! Движение вверх! 24H');
}
...
if (isBearishHammer) {
  console.log('Внимание! Медвежий молот! Движение вниз! 24H');
}
...
if (isDoji) {
console.log('Внимание! Доджи! Разворот! 24H');
}
...
if (isDarkCloudCover) {
console.log('Внимание! Завеса из облаков! Движение вниз! 24H');
}
...
console.log('Внимание! Медвежье поглощение! Движение вниз! 24H');
}
...
if (isBullishEngulfing) {
  console.log('Внимание! Бычье поглощение! Движение вверх! 24H');
}
...
if (isPiercingLine) {
console.log('Внимание! Пронизывающая! Разворот! 24H');
}
...
if (isTweezerTop) {
console.log('Внимание! Пинцет вершина! Движение вниз! 24H');
}
...
if (isTweezerBottom) {
console.log('Внимание! Пинцет основание! Движение вниз! 24H');
}
...
if (isMorningStar) {
console.log('Внимание! Пинцет основание! Движение вверх! 24H');
}
...
console.log('Внимание! Утреняя звезда Доджи! Движение вверх! 24H');
}
