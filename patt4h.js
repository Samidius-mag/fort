const fs = require('fs');
const data = JSON.parse(fs.readFileSync('price4.json'));
...
if (isBullishHammer) {
  console.log('Внимание! Бычий молот! Движение вверх! 4H');
}
...
if (isBearishHammer) {
  console.log('Внимание! Медвежий молот! Движение вниз! 4H');
}
...
if (isDoji) {
console.log('Внимание! Доджи! Разворот! 4H');
}
...
if (isDarkCloudCover) {
console.log('Внимание! Завеса из облаков! Движение вниз! 4H');
}
...
console.log('Внимание! Медвежье поглощение! Движение вниз! 4H');
}
...
if (isBullishEngulfing) {
  console.log('Внимание! Бычье поглощение! Движение вверх! 4H');
}
...
if (isPiercingLine) {
console.log('Внимание! Пронизывающая! Разворот! 4H');
}
...
if (isTweezerTop) {
console.log('Внимание! Пинцет вершина! Движение вниз! 4H');
}
...
if (isTweezerBottom) {
console.log('Внимание! Пинцет основание! Движение вниз! 4H');
}
...
if (isMorningStar) {
console.log('Внимание! Пинцет основание! Движение вверх! 4H');
}
...
console.log('Внимание! Утреняя звезда Доджи! Движение вверх! 4H');
}
